...
from utils import get_network, get_training_dataloader, get_training_dataloader_with_hierarhy, get_test_dataloader, get_test_dataloader_with_hierarhy, WarmUpLR, \
...
def eval_training(loss_function, cifar100_test_loader, epoch=0, tb=True, ):
    ...
    for (images, labels, class_labels) in cifar100_test_loader:
        ...
        correct1 += preds.eq(class_labels).sum()
